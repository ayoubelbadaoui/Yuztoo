part of 'hours_section.dart';

extension _HoursSectionUi on HoursSection {
  Widget _buildHoursSectionBody(BuildContext context, WidgetRef ref) {
  ...
  Widget _buildDaysCard(BuildContext context, BusinessHours businessHours,
      BusinessHoursNotifier notifier, bool hasClosure) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  void _handleToggle(BuildContext context, BusinessHoursNotifier notifier,
      DayHours dayHours, bool enabled) {
