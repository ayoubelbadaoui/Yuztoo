...
final navigationStateProvider = Provider<AsyncValue<NavigationState>>((ref) {
  ...
  if (authState is AuthError) {
    return const AsyncValue.data(NavigationUnauthenticated(ScreenId.roleSelection));
  }
...
final _authenticatedNavigationProvider = FutureProvider.family<NavigationState, AuthUser>((ref, user) async {
...
Future<NavigationState> _computeNavigationStateForUser(Ref ref, AuthUser user) async {
  // Get user role
