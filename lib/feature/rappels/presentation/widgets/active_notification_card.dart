  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          // ── top row: toggle + message (exact fixed height for uniform cards) ──
          SizedBox(
            height: 100,
            child: Padding(
                      ...
                      children: [
                        Text(
                          ...
                          style: GoogleFonts.outfit(
                            ...
                            color: isOn ? Colors.white : MerchantColors.textGrey,
                            height: 1.4,
                          ),
                        ),
                        const SizedBox(height: 8),
                        // Trigger + audience pills (single row, same height)
                        Row(
                          children: [
                            Flexible(
                              child: _infoPill(
